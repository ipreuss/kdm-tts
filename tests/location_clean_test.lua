...
-- Minimal stubs for Location module dependencies
...
-- Mock object factory
local function createMockObject(params)
    params = params or {}
...
-- Fake cast function that returns specified objects as hits
...
-- Mock Deck object factory with getObjects for contained cards
local function createMockDeck(params)
    params = params or {}
    local destroyed = false
